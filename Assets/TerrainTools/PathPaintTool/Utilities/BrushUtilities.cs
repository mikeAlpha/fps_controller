...
namespace UnityEditor.Experimental.TerrainAPI
{
    ...
    public static class BrushUtilities
    {
        ...
        public static void ShowDefaultPreviewBrush(Terrain terrain, Texture brushTexture, float brushSize)
        {
            ...
            {
                UnityEngine.TerrainTools.BrushTransform brushXform = UnityEngine.TerrainTools.TerrainPaintUtility.CalculateBrushTransform(terrain, hit.textureCoord, brushSize, 0.0f);
        ...
        public static void DrawBrushPreview(
            UnityEngine.TerrainTools.PaintContext heightmapPC,
            BrushPreview previewTexture,
            Texture brushTexture,                           // brush texture to apply
            UnityEngine.TerrainTools.BrushTransform brushXform,                      // brush transform that defines the brush UV space
