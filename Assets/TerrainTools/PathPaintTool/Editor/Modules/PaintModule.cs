    ...
    public class PaintModule : ModuleEditor
    {
        ...
        */
        ...
        private bool PaintTexture(Terrain terrain, IOnPaint editContext, Vector2 currUV)
        {
            ...
            UnityEngine.TerrainTools.PaintContext paintContext = UnityEngine.TerrainTools.TerrainPaintUtility.BeginPaintTexture(terrain, brushXform.GetBrushXYBounds(), m_SelectedInnerTerrainLayer);
            ...
            UnityEngine.TerrainTools.TerrainPaintUtility.EndPaintTexture(paintContext, "Terrain Paint - Texture");
