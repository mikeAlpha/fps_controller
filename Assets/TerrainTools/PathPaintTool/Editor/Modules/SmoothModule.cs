...
namespace UnityEditor.Experimental.TerrainAPI
{
    public class SmoothModule : ModuleEditor
    {
        ...
        private bool Smooth(Terrain terrain, IOnPaint editContext, Vector2 currUV)
        {
            ...
            UnityEngine.TerrainTools.BrushTransform brushXform = UnityEngine.TerrainTools.TerrainPaintUtility.CalculateBrushTransform(terrain, editContext.uv, brushSize, 0.0f);
            ...
            UnityEngine.TerrainTools.TerrainPaintUtility.EndPaintHeightmap(paintContext, "Terrain Paint - Smooth Height");
