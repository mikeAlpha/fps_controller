    ...
    public class StrokePaintMode : IPaintMode
    {
        ...
        public void OnSceneGUI(Terrain currentTerrain, IOnSceneGUI editContext)
        {
            if (m_StartTerrain != null && m_StartPoint != null)
            {
                ...
                UnityEngine.TerrainTools.BrushTransform anchorBrushXform = UnityEngine.TerrainTools.TerrainPaintUtility.CalculateBrushTransform(terrain, m_StartPoint, editContext.brushSize, 0.0f);
                UnityEngine.TerrainTools.PaintContext anchorCtx = UnityEngine.TerrainTools.TerrainPaintUtility.BeginPaintHeightmap(terrain, anchorBrushXform.GetBrushXYBounds(), 1);
                ...
                UnityEngine.TerrainTools.TerrainPaintUtility.ReleaseContextResources(anchorCtx);
